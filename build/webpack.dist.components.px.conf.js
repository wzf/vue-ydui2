...
module.exports = merge(distCommonWebpackConfig, {
  entry: {
    ...
    '/lib.px/imagepreview/index': './src/components/imagepreview/index.js',
    '/lib.px/canvasboard/index': './src/components/canvasboard/index.js',
    '/lib.px/picker/index': './src/components/picker/index.js'
  },
  module: {
    loaders: [
      {
